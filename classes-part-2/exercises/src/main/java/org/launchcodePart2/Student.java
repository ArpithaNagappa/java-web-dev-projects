...
//       double newTotalQualityScore = totalQualityScore + newQualityScore;
//       int newTotalNumberOfCredits = this.numberOfCredits +courseCredits;
//        this.numberOfCredits = newTotalNumberOfCredits;
//        this.gpa = newTotalQualityScore/newTotalNumberOfCredits;
//        /*
//             double totalQualityScore = this.gpa * this.numberOfCredits;
...
//        //String myGradeLevel  = sally.getGradeLevel(29);
